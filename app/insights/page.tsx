  ...
  return (
    <main className="pb-28 pt-4">
      ...
      <section className="mb-3 grid grid-cols-2 gap-2">
        ...
        <StatTile label="Best streak" value={String(bestStreak)} sub="days" accent="accent" />
        <StatTile label="Active habits" value={String(habits.length)} />
        <StatTile label="Total passes" value={String(passes)} accent="pass" />
      </section>

      <section className="mb-6">
        <h2 className="mb-2 mt-6 text-sm font-semibold text-text-secondary">
          Habit leaderboard
        </h2>
        {rows.length === 0 ? (
          <Card>
